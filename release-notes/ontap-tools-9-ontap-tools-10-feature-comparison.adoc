...
[role="lead"]
ONTAP tools for VMware vSphere 9からONTAP tools for VMware vSphere 10.1またはVMware vSphere 10.2への移行が適しているかどうかをご確認ください。互換性に関する最新情報については、を参照してください https://mysupport.netapp.com/matrix["NetApp Interoperability Matrix Tool"^]。

[cols="20%,25%,25%,30%"]
|===
| 機能 | ONTAPツール9.13 | ONTAPツール10.1 | ONTAPツール10.2 
...
| ONTAPリリースの認定 | ONTAP 9 .9.1からONTAP 9 .15.1へ | ONTAP 9 .12.1からONTAP 9 .14.1へ | ONTAP 9 .12.1からONTAP 9 .15.1へ 
...
| VASAプロバイダのサポート | VASA 4.0 | VASA 3.0 | VASA 3.0 
|===